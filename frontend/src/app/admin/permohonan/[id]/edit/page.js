...
export default function EditPermohonanPage() {
  ...
  return (
    <div className="max-w-4xl">
      ...
      <div className="mb-4">
        <h1 className="text-2xl font-bold text-gray-900">Edit Permohonan Surat</h1>
        <p className="text-sm text-gray-500 mt-1">Periksa dokumen permohonan dan perbarui status.</p>
      </div>
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 mb-4">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h2 className="text-base font-bold text-gray-900">Dokumen Pengguna</h2>
        </div>
            ...
            <div className="flex items-center justify-between bg-blue-50 rounded-xl border border-blue-200 px-4 py-3 mt-2">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium text-gray-700">{submission.letterType?.name}.docx</p>
                </div>
              </div>
              <button
